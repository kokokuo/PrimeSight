    ...
    public class GoodsRecognition
    {
        ...
        public GoodsRecognition(Image<Bgr, Byte> observedSrcImg)
        {
           ...
           // objectImg = GetObjectBoundingBoxImg(dst);
            ...
            string projectPath = dir.Parent.Parent.FullName;
            //讀取surf檔案的目錄下所有檔案名稱
            Console.WriteLine("\nPath=>" + projectPath + "\n");
            //隨著此類別存放的位置不同,要重新設定檔案路徑
            if (Directory.Exists(projectPath + @"\FeatureDataFiles\SURFFeatureData"))
            {
                surfFiles = Directory.GetFiles(projectPath + @"\FeatureDataFiles\SURFFeatureData").ToList();
            }
        ...
        {
            this.goodsData.Add("TW000000", "Pocky $ 35");
            this.goodsData.Add("TW000001", "Chocolate $ 40");
            this.goodsData.Add("TW000002", "檸檬熱飲,28元");
            this.goodsData.Add("TW000003", "AB無糖優酪乳,28元");
            this.goodsData.Add("TW000004", "bluebeerry  drops  $  100");
            this.goodsData.Add("TW000005", "bluebeerry  drops  $  100");
            this.goodsData.Add("TW000006", "huang yi ting");
            this.goodsData.Add("TW000007", "red tea $ 10");
            this.goodsData.Add("TW000008", "noodles $ 20");
            this.goodsData.Add("TW000009", "Toothpaste $ 62");
            this.goodsData.Add("TW000010", "huang yi ting");
            this.goodsData.Add("TW000011", "zip lock bag $ 45");
